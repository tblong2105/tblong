        ...
        carousel_textnav_1i0m: function() {
         ...
         carousel_numberdots_1i0m: function() {
            ...
            var owl = $('.featured-silder');
                    ...
                    $("<div class=\"itemnumber-dot\">0</div>").insertBefore(container);   
                    $("<div class=\"itemnumber-dot\">3</div>").insertAfter( container2);
                    
                     var htmlslider = $('#atbs-post-featured_2020').find('.itemnumber-dot:eq(0)');
                     var htmlslider1 = $('#atbs-post-featured_2020').find('.itemnumber-dot:last-child');
              ...
              function counter(event) { 
                ...
                if(currentIndex > totalItems) {
                 ...
                 htmlslider.html("0"+currentIndex+"").insertBefore(container);
                    
                     if(totalItems>9){
                        htmlslider1.html("0"+totalItems+"").insertAfter( container2);
                    }
                        htmlslider1.html("0"+totalItems+"").insertAfter( container2);
            }
